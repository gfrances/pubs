(define (problem instance_10_3)
  ...
  (:goal (and 
	...
	(= (poured plant9) 7)
	(= (poured plant10) 2)
	(sum_constraint (poured plant1) (poured plant2) (poured plant3) (poured plant4) (poured plant5) (poured plant6) (poured plant7) (poured plant8) (poured plant9) (poured plant10) (total_loaded))
  ))

  
  

  (:bounds (units - int[0..200]))
)
