(define (problem instance_9_1)
  ...
  (:goal (and 
	...
	(= (poured plant7) 3)
	(= (poured plant8) 2)
	(sum_constraint (poured plant1) (poured plant2) (poured plant3) (poured plant4) (poured plant5) (poured plant6) (poured plant7) (poured plant8) (total_loaded))
  ))

  
  

  (:bounds (units - int[0..160]))
)
