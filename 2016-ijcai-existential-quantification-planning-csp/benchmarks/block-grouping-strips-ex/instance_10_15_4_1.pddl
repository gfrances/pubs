...
(define (problem instance_10_15_4_1)
  ...
  (:goal
    (exists (?l0 ?l1 ?l2 ?l3 - location) ( and  (not (= ?l0 ?l1)) (not (= ?l0 ?l2)) (not (= ?l0 ?l3)) (not (= ?l1 ?l2)) (not (= ?l1 ?l3)) (not (= ?l2 ?l3)) (at b10 ?l3) (at b15 ?l2) (at b11 ?l2) (at b14 ?l0) (at b4 ?l3) (at b5 ?l3) (at b6 ?l2) (at b7 ?l3) (at b12 ?l0) (at b1 ?l0) (at b2 ?l0) (at b3 ?l2) (at b8 ?l1) (at b9 ?l0) (at b13 ?l2) ))
  )
