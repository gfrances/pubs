...
(define (problem instance_5_15_4_1)
  ...
  (:goal
    (exists (?l0 ?l1 ?l2 - location) ( and  (not (= ?l0 ?l1)) (not (= ?l0 ?l2)) (not (= ?l1 ?l2)) (at b10 ?l1) (at b15 ?l1) (at b11 ?l2) (at b14 ?l2) (at b4 ?l0) (at b5 ?l2) (at b6 ?l0) (at b7 ?l1) (at b12 ?l2) (at b1 ?l2) (at b2 ?l2) (at b3 ?l1) (at b8 ?l1) (at b9 ?l1) (at b13 ?l0) ))
  )
