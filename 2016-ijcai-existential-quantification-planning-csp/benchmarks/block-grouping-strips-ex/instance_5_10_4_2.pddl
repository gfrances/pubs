...
(define (problem instance_5_10_4_2)
  ...
  (:goal
    (exists (?l0 ?l1 ?l2 ?l3 - location) ( and  (not (= ?l0 ?l1)) (not (= ?l0 ?l2)) (not (= ?l0 ?l3)) (not (= ?l1 ?l2)) (not (= ?l1 ?l3)) (not (= ?l2 ?l3)) (at b10 ?l0) (at b4 ?l1) (at b5 ?l2) (at b6 ?l0) (at b7 ?l3) (at b1 ?l2) (at b2 ?l2) (at b3 ?l1) (at b8 ?l0) (at b9 ?l2) ))
  )
