...
(define (problem instance_5_15_4_2)
  ...
  (:goal
    (exists (?l0 ?l1 ?l2 ?l3 - location) ( and  (not (= ?l0 ?l1)) (not (= ?l0 ?l2)) (not (= ?l0 ?l3)) (not (= ?l1 ?l2)) (not (= ?l1 ?l3)) (not (= ?l2 ?l3)) (at b10 ?l2) (at b15 ?l1) (at b11 ?l1) (at b14 ?l1) (at b4 ?l3) (at b5 ?l3) (at b6 ?l3) (at b7 ?l0) (at b12 ?l0) (at b1 ?l1) (at b2 ?l3) (at b3 ?l1) (at b8 ?l0) (at b9 ?l0) (at b13 ?l0) ))
  )
